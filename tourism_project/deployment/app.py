...
# --- Paths --- #
MODEL_PATH = "tourism_project/model/best_tourism_prediction_model.joblib"
...
def load_model_and_encoders():
    try:
        ...
        st.error(f"Error loading essential files: {e}. Make sure 'tourism_project/model' and 'tourism_project/data' directories exist and contain the model and original data.")
        st.stop()
...
with st.form("prediction_form"):
    ...
    if submitted:
        ...
        for col, encoder in encoders.items():
            ...
            # A safer approach might involve a try-except or mapping to a default value
