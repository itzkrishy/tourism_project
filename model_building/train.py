...
# Define data paths, updated to be relative to /content when script is run from /content
data_dir = "tourism_project_local/data"
...
param_grid = {
    'xgbtclassifier__n_estimators': [50, 100, 150],
    'xgbtclassifier__max_depth': [3, 5, 7],
    'xgbtclassifier__learning_rate': [0.01, 0.05, 0.1],
    'xgbtclassifier__subsample': [0.6, 0.8, 1.0],
    'xgbtclassifier__colsample_bytree': [0.6, 0.8, 1.0],
    'xgbtclassifier__gamma': [0, 0.1, 0.2]
}
...
model_output_dir = "tourism_project_local/model" # Updated path
